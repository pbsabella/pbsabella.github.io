...
const InjectionSection = () => (
  ...
  >
    <p>
      ...
      <code className="code">@layer semantic</code> is declared last, it always wins the cascade over{' '}
      <code className="code">@layer brand</code>.
    </p>
    ...
    <div>
      <p>
        ...
        <code className="code">[data-brand]</code> block.
      </p>
      ...
      <ul className={styles.list}>
        <li>Brand files only set <code className="code">--brand-*</code> anchors, never <code className="code">--pr-*</code> or <code className="code">--sem-*</code>.</li>
        <li>Each brand lives in <code className="code">src/styles/brands/*.css</code> and is toggled via <code className="code">data-brand</code> on <code className="code">html</code>.</li>
        <li>Semantic tokens and theme logic stay centralized in <code className="code">tokens.css</code>.</li>
      </ul>
    </div>
    ...
    <Alert variant="info" title="Why layer order matters">
      ...
      <code className="code">@layer semantic</code>{' '}beats an identical rule in{' '}
      <code className="code">@layer brand</code>{' '}— even if the brand rule has a higher-specificity selector.
    </Alert>

    <div>
      <p>
        This handles more than just color; it handles geometry. Components no longer touch
        primitive radius values. They consume <code className="code">--sem-radius-md</code>, which reads from a
