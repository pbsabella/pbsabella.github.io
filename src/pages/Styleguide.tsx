      ...
      <section className={styles.section}>
        <div className={styles.sectionInner}>
          ...
          <p className={styles.description}>
            A living reference of the design tokens, primitives, and components used in this
            portfolio. This system demonstrates a tiered token architecture for scalable,
            maintainable design.
          </p>
          ...
          <p className={styles.sectionDesc}>
            Colors are organized by priority and semantic meaning.
          </p>
          ...
          <div className={styles.grid}>
            {[
              ...
              {
                name: 'Cyan Light',
                class: styles.swatchAccentCyanLight,
                token: '--color-accent-cyan-light',
              },
              {
                name: 'Neutral Accent',
                class: styles.swatchAccentNeutral,
                token: '--color-accent-neutral',
                border: true,
              },
            ].map((item, idx) => (
              <div className={styles.swatch} key={idx}>
          ...
          <p className={styles.sectionDesc}>
            These tokens adapt automatically based on the active theme.
          </p>
          <div className={styles.grid}>
            {[
          ...
          <div className={styles.typeExamples}>
            <h1
              data-component="Heading Level 1"
              data-tokens="size: --text-h1 | leading: --leading-tight"
            >
              Heading Level 1
            </h1>
            <h2
              data-component="Heading Level 2"
              data-tokens="size: --text-h2 | leading: --leading-normal"
            >
              Heading Level 2
            </h2>
            <h3
              data-component="Heading Level 3"
              data-tokens="size: --text-h3 | leading: --leading-normal"
            >
              Heading Level 3
            </h3>
            <p
              data-component="Body Text"
              data-tokens="size: --text-body | leading: --leading-body-wide"
            >
          ...
          <div className={styles.tagsRow}>
            <Tag data-component="Tag" data-tokens="bg: --tag-bg-color | color: --tag-text-color">
              React
            </Tag>
            <Tag>CSS Modules</Tag>
            <Tag>Vite</Tag>
