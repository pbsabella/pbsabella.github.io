...
export const TldrSection = () => (
  <Callout
    ...
    style={{ marginBottom: 'var(--pr-spacing-8)' }}
  >
...
export const ProblemSection = () => (
  <EditorialBlock id="problem" kicker="02. Define" title="Beyond the Balance">
    ...
    <Grid colsSm={2} gap="lg" align="start">
      <IconList
        variant="list"
        items={[
          {
...
export const DecisionsSection = () => (
  <EditorialBlock id="decisions" kicker="03. Ideate" title="Design for High-Stakes Decisions" rhythm="21">
    ...
    <div>
      <p className={styles.groupTitle}>Logic for Financial Reality</p>
    ...
    <div>
      <p className={styles.groupTitle}>Designed Without a Manual</p>
      <IconList
        variant="grid"
        items={[
          {
...
----------------------------------------------------`}
    ...
    <Grid colsSm={2} gap="lg" align="start">
      <div>
        ...
        <p className="caption">The cash flow projection needed to show two very different things in the same view: interest earned (what I budget) and principal returned (what I can move). These look like the same number in a spreadsheet. They&apos;re completely different decisions.</p>
